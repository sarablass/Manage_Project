...
internal static class DataSource 
{
    ...
    {
        internal const int startTaskId = 100; //A const numeric field, with the internal permission, that will receive an initial value for the number running, the smallest identifying number.
        ...
        internal const int startDependencyId = 250; //A const numeric field, with the internal permission, that will receive an initial value for the number running, the smallest identifying number.
